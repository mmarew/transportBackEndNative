const SHIPPER_REQUEST_ENDPOINTS = {
  ...
  GET_SHIPPER_REQUEST_4_ALL_OR_SINGLE_USER: "/api/user/getShipperRequest4allOrSingleUser",
  ...
  CANCEL_SHIPPER_REQUEST: "/api/shipperRequest/cancelShipperRequest/:userUniqueId",
  CANCEL_BATCH: "/api/shipperRequest/cancelBatch/:shipperRequestBatchId",
  MARK_JOURNEY_COMPLETION_AS_SEEN: "/api/shipperRequest/markJourneyCompletionAsSeen",
  GET_CANCELLATION_NOTIFICATIONS: "/api/shipperRequest/getCancellationNotifications",
