 ...
 */
router.post("/api/company/assignments", validator(schema.createAssignment), controller.createAssignment);

/**
 * @route   GET /api/company/assignments
 */
router.get("/api/company/assignments", validator(schema.getAssignmentsQuery, "query"), controller.getAssignments);
