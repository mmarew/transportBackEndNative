...
const usersRoles = {
  ...
  queueDispatcherRoleId: 12, // queue dispatcher — staff under the org admin, runs the queue
};
const usersRolesList = {
  ...
  queueDispatcher: { roleId: 12, roleName: "Queue Dispatcher" },
};
const roleList = [
  {
    roleId: 1,
  ...
  },
  {
    roleId: 12,
    roleUniqueId: uuidv4(),
    roleName: "Queue Dispatcher",
    roleDescription:
      "Queue organization staff under the org admin: runs the dispatch queue (check-in/out, view, dispatch, disputes) but cannot add or remove staff or org members.",
    roleCreatedAt: currentDate(),
  },
];
/**
...
const cancellationReasons = [
  ...
  {
    cancellationReason: "Driver did not arrive at the pickup location on time",
    roleId: 1,
    requestMode: "individual",
  },
  {
    cancellationReason: "Driver's vehicle did not match the request",
    roleId: 1,
    requestMode: "individual",
  },
  {
    cancellationReason: "Company did not assign vehicles as agreed",
    roleId: 1,
    requestMode: "company",
  },
  {
    cancellationReason: "Found a better price or alternative option",
    roleId: 1,
    requestMode: "both",
  },
  {
    cancellationReason: "Cargo no longer needs to be transported",
    roleId: 1,
    requestMode: "both",
  },
  {
  ...
  {
    cancellationReason: "Cargo did not match the request description",
    roleId: 2,
    requestMode: "individual",
  },
  {
    cancellationReason: "Company changed or reassigned the job",
    roleId: 2,
    requestMode: "company",
  },
  {
  ...
  {
    cancellationReason: "Driver unavailable or did not respond",
    roleId: 11,
    requestMode: "both",
  },
  {
    cancellationReason: "Duplicate or incorrectly placed order",
    roleId: 11,
    requestMode: "both",
  },
  {
    cancellationReason: "Order was placed by mistake",
    roleId: 11,
    requestMode: "both",
  },
  {
